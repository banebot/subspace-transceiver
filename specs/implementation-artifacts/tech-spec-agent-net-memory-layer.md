---
title: 'Subspace Transceiver: Global Agent Internet (v2 — Iroh + Loro)'
...
v2MigratedAt: '2026-03-07T20:00:00Z'
tech_stack:
  - 'Node.js v20+ / Bun 1.3 (TypeScript, ESM)'
  - 'iroh@0.96 (QUIC transport, via Rust engine sidecar)'
  - 'iroh-gossip@0.96 (HyParView/Plumtree epidemic broadcast)'
  - 'loro-crdt@1.10.6 (CRDT memory store, replaces OrbitDB)'
  - '@libp2p/crypto@5.1.13 + @libp2p/peer-id@6.0.4 (Ed25519 identity utilities only)'
  - 'Node.js crypto (HKDF, AES-256-GCM — built-in, no extra dep)'
  - 'fastify@5.7.4 (daemon HTTP API)'
  - 'commander@14.0.3 (CLI)'
  - 'vitest@4.0.18 (tests — 243 passing)'
  - 'yaml@2.8.2 + uuid@13.0.0'
  - 'Rust 1.75+ (stable) for packages/engine'
  - 'DID:Key (W3C DID Core + DID Key Method) for agent identity'
  - 'ANP/0.1 (Agent Network Protocol) for capability negotiation'
migration_from:
  - 'libp2p@3.1.4 (transport removed, crypto utilities kept)'
  - '@orbitdb/core@3.0.2 + helia@6.0.20 (removed, replaced by Loro CRDT)'
  - '@chainsafe/libp2p-gossipsub (removed, replaced by iroh-gossip)'
files_to_modify:
