 ...
 */
export async function loadOrCreateIdentity(identityPath = DEFAULT_IDENTITY_PATH) {
    ...
    if (existsSync(identityPath)) {
        ...
        if (seed.length !== 32) {
            ...
            console.warn(`[subspace] Identity file at ${identityPath} is corrupt (${seed.length} bytes, expected 32). Regenerating.`);
